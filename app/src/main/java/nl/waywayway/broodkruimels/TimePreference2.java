...
public class TimePreference2 extends Preference
{
	...
	public  TimePreference2(Context context, AttributeSet attrs, int defStyleAttr)
	{
		this(context, attrs, defStyleAttr, defStyleAttr);
	}

	public  TimePreference2(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes)
	{
	...
	private void onBindDialogView(View view)
	{
		...
		TimePreference2 preference = (TimePreference2) findPreferenceInHierarchy("pref_notify_time");
	...
	private void onDialogClosed(boolean positiveResult)
	{
		...
		if (positiveResult)
		{
			...
			// Save the value
			TimePreference2 timePreference = (TimePreference2) findPreferenceInHierarchy("pref_notify_time");
